...
ROUND_EXCLUSION_OUTPUT = Path(
    "data/interim/v3_dev_round_exclusions.csv"
)

DROP_AUDIT_OUTPUT = Path(
    "data/interim/v3_dev_drop_semantic_audit.csv"
)
...
# ============================================================
# Verify frozen manifest identity
# ============================================================
...
require(
    ...
    "D_V3_DEV identity is not frozen.",
)
...
require(
    ...
    (
        "D_V3_DEV manifest SHA changed after freeze.\n"
        f"Expected: {manifest_identity['manifest_sha256']}\n"
...
require(
    ...
    == EXPECTED_MATCHES,
    (
        f"Expected {EXPECTED_MATCHES} development matches, "
...
require(
    ...
    == EXPECTED_MATCHES,
    "Duplicate demo SHA inside D_V3_DEV manifest.",
)
...
require(
    ...
    == EXPECTED_MATCHES,
    (
        "Not all 53 development matches "
        "contributed valid target rows."
    ),
)
...
print()
print("=" * 108)
print("D_V3_DEV TARGET DATASET SUMMARY")
print("=" * 108)

print(
    "Matches with valid targets:",
    dataset[
        "demo_filename"
    ].n_unique(),
)
...
print(
    "Excluded horizon rows:",
    f"{exclusions.height:,}",
)

print(
    "Round exclusions:",
    round_exclusions.height,
)


print()
print("VALID ROWS BY HORIZON")
print("-" * 108)
...
print()
print("ROUND EXCLUSION REASONS")
print("-" * 108)

if round_exclusions.height:
...
print()
print("DROP SEMANTIC RECOVERY — 53 MATCHES")
print("-" * 108)
...
identity = {
    ...
    "future_information_used_as_feature":
        False,
...
if IDENTITY_OUTPUT.exists():
    ...
    require(
        ...
        == identity,
        (
            "Existing frozen V3 target dataset "
            "identity differs from proposed identity."
        ),
    )

    print()
    print(
        "✅ Existing target dataset identity verified"
    )
    ...
    print()
    print(
        "✅ Target dataset identity frozen"
    )
...
print(
    "NEXT_ACTION=FREEZE_V3_DEV_CV_SPLITS_AND_RUN_B0"
)
...
print(" ", EXCLUSION_OUTPUT)
print(" ", ROUND_EXCLUSION_OUTPUT)
print(" ", DROP_AUDIT_OUTPUT)
